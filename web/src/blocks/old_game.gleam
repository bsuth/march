import blocks/old_game/board_view.{board_view}
import blocks/old_game/hand_view.{hand_view}
...
import old_engine/card
import old_engine/classic.{type Classic, Classic}
import old_engine/color
import old_engine/player

// -----------------------------------------------------------------------------
// Component
// -----------------------------------------------------------------------------

const element_name = "blocks-old-game"
